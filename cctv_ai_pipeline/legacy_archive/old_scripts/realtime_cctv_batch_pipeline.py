...
from tensorrt_wrapper import SharedCSRNetEngine
...
if not MODEL_PATH or not os.path.exists(MODEL_PATH):
    MODEL_PATH = os.path.join(WORKSPACE_DIR, "models", "csrnet_ultimate_epoch_8.pth")
if not os.path.exists(MODEL_PATH):
    MODEL_PATH = os.path.join(RESULTS_DIR, "csrnet_ultimate_epoch_8.pth")
if not os.path.exists(MODEL_PATH):
    MODEL_PATH = os.path.join(BASE_DIR, "models", "csrnet_ultimate_epoch_8.pth")
